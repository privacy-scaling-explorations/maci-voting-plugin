...
export const PLUGIN_CONTRACT_NAME = 'MaciVoting'; // See `packages/contracts/src/MyPlugin.sol`.
export const PLUGIN_SETUP_CONTRACT_NAME = 'MaciVotingSetup'; // See `packages/contracts/src/MyPluginSetup.sol`.
...
export const PLUGIN_REPO_ENS_SUBDOMAIN_NAME = 'maci-voting';
